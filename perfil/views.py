...
def gerenciar(request):
    ...
    return render(request, 'gerenciar.html', {'contas': contas, 'total_contas': total_contas, 'banco_choices': Conta.banco_choices, 'tipo_choices': Conta.tipo_choices, 'categorias': categorias })
