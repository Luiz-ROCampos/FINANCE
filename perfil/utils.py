...
def calcula_equilibrio_financeiro():
    ...
    try:
        percentual_essenciais = total_gastos_essenciais * 100 / total
        percentual_nao_essenciais = total_gastos_nao_essenciais * 100 / total
        return percentual_essenciais, percentual_nao_essenciais
